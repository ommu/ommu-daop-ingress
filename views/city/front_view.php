...
<div class="boxed box-info">
	...
	<div class="info">
		...
		<div>
			...
			<a href="<?php echo Yii::app()->controller->createUrl('province/view', array('id'=>$model->city_relation->province->province_id,'t'=>$this->urlTitle($model->city_relation->province->province)))?>" title="<?php echo $model->city_relation->province->province;?>"><?php echo $model->city_relation->province->province;?></a>, <?php echo $model->city_relation->province->country->country;?>
		</div>
	</div>
	<div class="area-info">
		<ul class="clearfix">
			<li <?php echo ($action == 'view') ? 'class="active"' : '';?>><a off_address="" class="profile" href="<?php echo Yii::app()->controller->createUrl('view', array('id'=>$model->city_id,'t'=>$this->urlTitle($model->city_relation->city)))?>" title="Profile">Profile</a></li>
			<li <?php echo ($action == 'member') ? 'class="active"' : '';?>><a off_address="" class="agents" href="<?php echo Yii::app()->controller->createUrl('member', array('id'=>$model->city_id,'t'=>$this->urlTitle($model->city_relation->city)))?>" title="<?php echo $model->users?> Agent">Agent [<?php echo $model->users?>]</a></li>
			<li <?php echo ($action == 'another') ? 'class="active"' : '';?>><a off_address="" class="anothers" href="<?php echo Yii::app()->controller->createUrl('another', array('id'=>$model->city_id,'t'=>$this->urlTitle($model->city_relation->city)))?>" title="<?php echo $model->anothers?> Spesific Area">Spesific Area [<?php echo $model->anothers?>]</a></li>
			<li class="last"><a href="<?php echo Yii::app()->controller->createUrl('update', array('id'=>$model->id,'t'=>$this->urlTitle($model->city_relation->city)))?>" title="Update Info">Update Info</a></li>
		</ul>
	</div>
</div>
